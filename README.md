kruglikovAlex[![IT Shark](https://avatars2.githubusercontent.com/u/34164782?s=200&v=4)](http://it-shark.pro/)
# Brest IT Shark School
## Javascript Assignments  [![Build Status](https://travis-ci.org/kruglikovAlex/js-assignments.svg?branch=master)](https://travis-ci.org/kruglikovAlex/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'kruglikovAlex'` with your account name).
...
```
* Open https://github.com/kruglikovAlex/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/kruglikovAlex/js-assignments/builds).
